...
-- ----------------------------
INSERT INTO `QRTZ_SCHEDULER_STATE` VALUES ('GhcScheduler', 'DESKTOP-LW1591454217215', 1591454730692, 15000);
...
-- ----------------------------
INSERT INTO `QRTZ_TRIGGERS` VALUES ('GhcScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', NULL, 1591454220000, -1, 5, 'PAUSED', 'CRON', 1591454217000, 0, NULL, 2, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('GhcScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', NULL, 1591454220000, -1, 5, 'PAUSED', 'CRON', 1591454217000, 0, NULL, 2, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('GhcScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', NULL, 1591454220000, -1, 5, 'PAUSED', 'CRON', 1591454217000, 0, NULL, 2, '');
...
CREATE TABLE `blog_article`  (
  ...
  `status` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '文章状态(0 审核中 1审核通过 2审核拒绝)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1006 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文章表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `blog_article_tag`  (
  ...
  `update_time` datetime(0) NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1023 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文章标签表' ROW_FORMAT = Dynamic;
...
INSERT INTO `blog_article_tag` VALUES (1025, 1007, 6, '2020-06-05 20:27:27', '2020-06-05 20:27:27');
INSERT INTO `blog_article_tag` VALUES (1026, 1007, 1, '2020-06-05 20:27:27', '2020-06-05 20:27:27');
...
INSERT INTO `blog_category` VALUES (2, '后端', 'end_back.jpg', '后端分类描述', '2018-07-06 14:50:52');
...
CREATE TABLE `blog_comment`  (
  ...
  `update_time` datetime(0) NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 106 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '评论表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `blog_record`  (
  ...
  `user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人id',
...
-- ----------------------------
INSERT INTO `blog_record` VALUES (9, 2, '      #后台\n      #更新登录界面背景图\n      #修复登录后无法获取头像的问题\n      #新增文章审核、文章列表、分类管理、标签管理页面\n      #相关bug修复', '2020-06-06 22:44:28');
...
-- Records of blog_tag
-- ----------------------------
INSERT INTO `blog_tag` VALUES (1, 'Java', 'java.jpg', '2018-07-06 14:40:41', 'Java描述');
...
INSERT INTO `gen_table` VALUES (7, 'blog_record', '', 'BlogRecord', 'crud', 'com.jblog.project.system', 'system', 'record', NULL, 'jblog', NULL, 'happy', '2020-06-06 00:02:08', '', NULL, NULL);
...
INSERT INTO `gen_table_column` VALUES (53, '7', 'id', 'id', 'int', 'Long', 'id', '1', '0', NULL, '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'happy', '2020-06-06 00:02:08', '', NULL);
INSERT INTO `gen_table_column` VALUES (54, '7', 'user_id', '创建人id', 'bigint', 'Long', 'userId', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 2, 'happy', '2020-06-06 00:02:08', '', NULL);
INSERT INTO `gen_table_column` VALUES (55, '7', 'content', '内容', 'text', 'String', 'content', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 3, 'happy', '2020-06-06 00:02:08', '', NULL);
INSERT INTO `gen_table_column` VALUES (56, '7', 'created_at', '创建时间', 'datetime', 'Date', 'createdAt', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'datetime', '', 4, 'happy', '2020-06-06 00:02:08', '', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 364 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_logininfor` VALUES (362, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-05 15:09:45');
INSERT INTO `sys_logininfor` VALUES (363, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-05 15:13:12');
INSERT INTO `sys_logininfor` VALUES (364, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-05 15:46:49');
INSERT INTO `sys_logininfor` VALUES (365, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-05 16:08:39');
INSERT INTO `sys_logininfor` VALUES (366, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-05 16:12:03');
INSERT INTO `sys_logininfor` VALUES (367, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-05 16:48:38');
INSERT INTO `sys_logininfor` VALUES (368, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-05 17:41:43');
INSERT INTO `sys_logininfor` VALUES (369, 'shadow', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '验证码错误', '2020-06-05 18:27:26');
INSERT INTO `sys_logininfor` VALUES (370, 'shadow', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-05 18:27:33');
INSERT INTO `sys_logininfor` VALUES (371, 'shadow', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '验证码已失效', '2020-06-05 18:27:34');
INSERT INTO `sys_logininfor` VALUES (372, 'shadow', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2020-06-05 18:29:58');
INSERT INTO `sys_logininfor` VALUES (373, 'shadow', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-05 19:41:11');
INSERT INTO `sys_logininfor` VALUES (374, 'shadow', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2020-06-05 19:54:16');
INSERT INTO `sys_logininfor` VALUES (375, 'shadow', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-05 19:54:26');
INSERT INTO `sys_logininfor` VALUES (376, 'shadow', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2020-06-05 20:08:53');
INSERT INTO `sys_logininfor` VALUES (377, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-05 20:09:20');
INSERT INTO `sys_logininfor` VALUES (378, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2020-06-05 20:11:10');
INSERT INTO `sys_logininfor` VALUES (379, 'shadow', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-05 20:11:22');
INSERT INTO `sys_logininfor` VALUES (380, 'shadow', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-05 20:22:04');
INSERT INTO `sys_logininfor` VALUES (381, 'shadow', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2020-06-05 20:22:30');
INSERT INTO `sys_logininfor` VALUES (382, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-05 20:22:51');
INSERT INTO `sys_logininfor` VALUES (383, 'shadow', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2020-06-05 20:27:03');
INSERT INTO `sys_logininfor` VALUES (384, 'shadow', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-05 20:27:08');
INSERT INTO `sys_logininfor` VALUES (385, 'shadow', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2020-06-05 20:28:17');
INSERT INTO `sys_logininfor` VALUES (386, 'shadow', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-05 20:28:31');
INSERT INTO `sys_logininfor` VALUES (387, 'shadow', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2020-06-05 20:28:34');
INSERT INTO `sys_logininfor` VALUES (388, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-05 20:28:48');
INSERT INTO `sys_logininfor` VALUES (389, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-05 21:17:05');
INSERT INTO `sys_logininfor` VALUES (390, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '验证码错误', '2020-06-05 23:56:57');
INSERT INTO `sys_logininfor` VALUES (391, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-05 23:57:04');
INSERT INTO `sys_logininfor` VALUES (392, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2020-06-05 23:58:26');
INSERT INTO `sys_logininfor` VALUES (393, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-05 23:58:41');
INSERT INTO `sys_logininfor` VALUES (394, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-06 00:34:55');
INSERT INTO `sys_logininfor` VALUES (395, 'shadow', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-06 00:54:15');
INSERT INTO `sys_logininfor` VALUES (396, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-06 02:24:14');
INSERT INTO `sys_logininfor` VALUES (397, 'shadow', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-06 03:25:28');
INSERT INTO `sys_logininfor` VALUES (398, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-06 04:16:57');
INSERT INTO `sys_logininfor` VALUES (399, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-06 04:55:58');
INSERT INTO `sys_logininfor` VALUES (400, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2020-06-06 05:19:55');
INSERT INTO `sys_logininfor` VALUES (401, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-06 05:20:07');
INSERT INTO `sys_logininfor` VALUES (402, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2020-06-06 05:20:16');
INSERT INTO `sys_logininfor` VALUES (403, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-06 05:20:28');
INSERT INTO `sys_logininfor` VALUES (404, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2020-06-06 05:21:49');
INSERT INTO `sys_logininfor` VALUES (405, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-06 05:22:51');
INSERT INTO `sys_logininfor` VALUES (406, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2020-06-06 05:23:22');
INSERT INTO `sys_logininfor` VALUES (407, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-06 05:23:33');
INSERT INTO `sys_logininfor` VALUES (408, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2020-06-06 06:14:11');
INSERT INTO `sys_logininfor` VALUES (409, 'happy', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-06 06:15:41');
INSERT INTO `sys_logininfor` VALUES (410, 'shadow', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-06-06 06:21:39');
INSERT INTO `sys_logininfor` VALUES (411, 'shadow', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2020-06-06 06:28:35');
...
INSERT INTO `sys_menu` VALUES (105, '字典管理', 1, 6, 'dict', 'system/dict/index', 1, 'C', '0', 'system:dict:list', 'dict', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '字典管理菜单', '1');
INSERT INTO `sys_menu` VALUES (106, '参数设置', 1, 7, 'config', 'system/config/index', 1, 'C', '0', 'system:config:list', 'edit', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '参数设置菜单', '1');
INSERT INTO `sys_menu` VALUES (107, '通知公告', 1, 8, 'notice', 'system/notice/index', 1, 'C', '0', 'system:notice:list', 'message', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '通知公告菜单', '1');
...
INSERT INTO `sys_menu` VALUES (110, '定时任务', 2, 2, 'job', 'monitor/job/index', 1, 'C', '0', 'monitor:job:list', 'job', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '定时任务菜单', '1');
INSERT INTO `sys_menu` VALUES (111, '数据监控', 2, 3, 'druid', 'monitor/druid/index', 1, 'C', '0', 'monitor:druid:list', 'druid', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '数据监控菜单', '1');
...
INSERT INTO `sys_menu` VALUES (2006, '网站管理', 0, 4, 'website', NULL, 1, 'M', '0', NULL, 'server', 'admin', '2020-04-21 10:48:52', '', NULL, '', '1');
...
INSERT INTO `sys_menu` VALUES (2010, '权限管理', 0, 4, 'permission', NULL, 1, 'M', '0', NULL, 'eye-open', 'admin', '2020-04-21 10:57:46', '', NULL, '', '1');
...
INSERT INTO `sys_oper_log` VALUES (23, '用户管理', 2, 'com.jblog.project.blog.user.controller.UserController.edit()', 'POST', 1, 'shadow', NULL, '/user/updateUser', '127.0.0.1', '内网IP', '{\"phonenumber\":\"1566622222\",\"admin\":false,\"updateBy\":\"shadow\",\"addr\":\"湖南长沙\",\"email\":\"2581992919@qq.com\",\"nickName\":\"shadow\",\"sex\":\"0\",\"label\":\"勇往直前111\",\"params\":{},\"userName\":\"shadow\",\"userId\":2}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-05 20:26:35');
INSERT INTO `sys_oper_log` VALUES (24, '代码生成', 6, 'com.jblog.project.tool.gen.controller.GenController.importTableSave()', 'POST', 1, 'happy', NULL, '/tool/gen/importTable', '127.0.0.1', '内网IP', 'blog_record', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 00:02:08');
INSERT INTO `sys_oper_log` VALUES (25, '【请填写功能名称】', 2, 'com.jblog.project.blog.record.controller.RecordController.edit()', 'POST', 1, 'shadow', NULL, '/record/updateRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591434438000,\"id\":1,\"userId\":1,\"content\":\"aaabbb\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 01:07:58');
INSERT INTO `sys_oper_log` VALUES (26, '【请填写功能名称】', 2, 'com.jblog.project.blog.record.controller.RecordController.edit()', 'POST', 1, 'shadow', NULL, '/record/updateRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591434438000,\"id\":1,\"userId\":1,\"content\":\"aaabbb\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 01:08:05');
INSERT INTO `sys_oper_log` VALUES (27, '【请填写功能名称】', 2, 'com.jblog.project.blog.record.controller.RecordController.edit()', 'POST', 1, 'shadow', NULL, '/record/updateRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591434438000,\"id\":1,\"userId\":1,\"content\":\"aaabbbbbb\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 01:09:40');
INSERT INTO `sys_oper_log` VALUES (28, '【请填写功能名称】', 2, 'com.jblog.project.blog.record.controller.RecordController.edit()', 'POST', 1, 'shadow', NULL, '/record/updateRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591434438000,\"id\":1,\"userId\":1,\"content\":\"aaabbbbbbccc\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 01:28:38');
INSERT INTO `sys_oper_log` VALUES (29, '【请填写功能名称】', 2, 'com.jblog.project.blog.record.controller.RecordController.edit()', 'POST', 1, 'shadow', NULL, '/record/updateRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591434438000,\"id\":1,\"userId\":1,\"content\":\"nnnnn\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 01:28:57');
INSERT INTO `sys_oper_log` VALUES (30, '【请填写功能名称】', 3, 'com.jblog.project.blog.record.controller.RecordController.remove()', 'POST', 1, 'shadow', NULL, '/record/deleteRecord', '127.0.0.1', '内网IP', '1', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 01:30:41');
INSERT INTO `sys_oper_log` VALUES (31, '【请填写功能名称】', 2, 'com.jblog.project.blog.record.controller.RecordController.edit()', 'POST', 1, 'shadow', NULL, '/record/updateRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591434438000,\"id\":1,\"userId\":1,\"content\":\"nnnnn\"}', '{\"msg\":\"操作失败\",\"code\":500}', 0, NULL, '2020-06-06 01:31:02');
INSERT INTO `sys_oper_log` VALUES (32, '【请填写功能名称】', 1, 'com.jblog.project.blog.record.controller.RecordController.add()', 'POST', 1, 'shadow', NULL, '/record/addRecord', '127.0.0.1', '内网IP', '{\"content\":\"sss\"}', 'null', 1, '\r\n### Error updating database.  Cause: java.sql.SQLException: Field \'id\' doesn\'t have a default value\r\n### The error may involve defaultParameterMap\r\n### The error occurred while setting parameters\r\n### SQL: insert into blog_record          ( content )           values ( ? )\r\n### Cause: java.sql.SQLException: Field \'id\' doesn\'t have a default value\n; Field \'id\' doesn\'t have a default value; nested exception is java.sql.SQLException: Field \'id\' doesn\'t have a default value', '2020-06-06 01:45:09');
INSERT INTO `sys_oper_log` VALUES (33, '【请填写功能名称】', 1, 'com.jblog.project.blog.record.controller.RecordController.add()', 'POST', 1, 'shadow', NULL, '/record/addRecord', '127.0.0.1', '内网IP', '{\"content\":\"bbbb\"}', 'null', 1, '\r\n### Error updating database.  Cause: java.sql.SQLException: Field \'id\' doesn\'t have a default value\r\n### The error may involve defaultParameterMap\r\n### The error occurred while setting parameters\r\n### SQL: insert into blog_record          ( content )           values ( ? )\r\n### Cause: java.sql.SQLException: Field \'id\' doesn\'t have a default value\n; Field \'id\' doesn\'t have a default value; nested exception is java.sql.SQLException: Field \'id\' doesn\'t have a default value', '2020-06-06 01:54:01');
INSERT INTO `sys_oper_log` VALUES (34, '【请填写功能名称】', 1, 'com.jblog.project.blog.record.controller.RecordController.add()', 'POST', 1, 'shadow', NULL, '/record/addRecord', '127.0.0.1', '内网IP', '{\"content\":\"bbbb\"}', 'null', 1, '\r\n### Error updating database.  Cause: java.sql.SQLException: Field \'id\' doesn\'t have a default value\r\n### The error may involve defaultParameterMap\r\n### The error occurred while setting parameters\r\n### SQL: insert into blog_record          ( content )           values ( ? )\r\n### Cause: java.sql.SQLException: Field \'id\' doesn\'t have a default value\n; Field \'id\' doesn\'t have a default value; nested exception is java.sql.SQLException: Field \'id\' doesn\'t have a default value', '2020-06-06 01:54:13');
INSERT INTO `sys_oper_log` VALUES (35, '【请填写功能名称】', 1, 'com.jblog.project.blog.record.controller.RecordController.add()', 'POST', 1, 'shadow', NULL, '/record/addRecord', '127.0.0.1', '内网IP', '{\"content\":\"bbbbccc\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 01:56:05');
INSERT INTO `sys_oper_log` VALUES (36, '【请填写功能名称】', 2, 'com.jblog.project.blog.record.controller.RecordController.edit()', 'POST', 1, 'shadow', NULL, '/record/updateRecord', '127.0.0.1', '内网IP', '{\"id\":1,\"content\":\"bbbbcccggg\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 01:56:11');
INSERT INTO `sys_oper_log` VALUES (37, '【请填写功能名称】', 3, 'com.jblog.project.blog.record.controller.RecordController.remove()', 'POST', 1, 'shadow', NULL, '/record/deleteRecord', '127.0.0.1', '内网IP', '1', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 01:56:23');
INSERT INTO `sys_oper_log` VALUES (38, '【请填写功能名称】', 1, 'com.jblog.project.blog.record.controller.RecordController.add()', 'POST', 1, 'shadow', NULL, '/record/addRecord', '127.0.0.1', '内网IP', '{\"content\":\"bbbbb\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 01:59:59');
INSERT INTO `sys_oper_log` VALUES (39, '【请填写功能名称】', 3, 'com.jblog.project.blog.record.controller.RecordController.remove()', 'POST', 1, 'shadow', NULL, '/record/deleteRecord', '127.0.0.1', '内网IP', '2', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 02:06:13');
INSERT INTO `sys_oper_log` VALUES (40, '【请填写功能名称】', 1, 'com.jblog.project.blog.record.controller.RecordController.add()', 'POST', 1, 'shadow', NULL, '/record/addRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591439022870,\"userId\":2,\"content\":\"bbb\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 02:07:45');
INSERT INTO `sys_oper_log` VALUES (41, '【请填写功能名称】', 2, 'com.jblog.project.blog.record.controller.RecordController.edit()', 'POST', 1, 'shadow', NULL, '/record/updateRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591439023000,\"id\":3,\"userId\":2,\"content\":\"bbbfff\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 02:10:32');
INSERT INTO `sys_oper_log` VALUES (42, '【请填写功能名称】', 2, 'com.jblog.project.blog.record.controller.RecordController.edit()', 'POST', 1, 'shadow', NULL, '/record/updateRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591439023000,\"id\":3,\"userId\":2,\"content\":\"bbbfffbbb\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 02:16:16');
INSERT INTO `sys_oper_log` VALUES (43, '【请填写功能名称】', 1, 'com.jblog.project.blog.record.controller.RecordController.add()', 'POST', 1, 'shadow', NULL, '/record/addRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591439619476,\"userId\":2,\"content\":\"fff\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 02:17:42');
INSERT INTO `sys_oper_log` VALUES (44, '【请填写功能名称】', 3, 'com.jblog.project.blog.record.controller.RecordController.remove()', 'POST', 1, 'shadow', NULL, '/record/deleteRecord', '127.0.0.1', '内网IP', '4', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 02:17:53');
INSERT INTO `sys_oper_log` VALUES (45, '用户管理', 2, 'com.jblog.project.system.controller.SysUserController.changeStatus()', 'PUT', 1, 'happy', NULL, '/system/user/changeStatus', '127.0.0.1', '内网IP', '{\"admin\":false,\"updateBy\":\"happy\",\"params\":{},\"userId\":108,\"status\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 05:04:53');
INSERT INTO `sys_oper_log` VALUES (46, '用户管理', 2, 'com.jblog.project.system.controller.SysUserController.changeStatus()', 'PUT', 1, 'happy', NULL, '/system/user/changeStatus', '127.0.0.1', '内网IP', '{\"admin\":false,\"updateBy\":\"happy\",\"params\":{},\"userId\":108,\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 05:04:54');
INSERT INTO `sys_oper_log` VALUES (47, '操作日志', 5, 'com.jblog.project.monitor.controller.SysOperlogController.export()', 'GET', 1, 'happy', NULL, '/monitor/operlog/export', '127.0.0.1', '内网IP', '{}', '{\"msg\":\"d0280794-8fb7-4e3e-a08e-f3ad82fe9aa2_操作日志.xlsx\",\"code\":200}', 0, NULL, '2020-06-06 06:17:19');
INSERT INTO `sys_oper_log` VALUES (48, '【请填写功能名称】', 3, 'com.jblog.project.blog.record.controller.RecordController.remove()', 'POST', 1, 'shadow', NULL, '/record/deleteRecord', '127.0.0.1', '内网IP', '3', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 06:21:47');
INSERT INTO `sys_oper_log` VALUES (49, '【请填写功能名称】', 1, 'com.jblog.project.blog.record.controller.RecordController.add()', 'POST', 1, 'shadow', NULL, '/record/addRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591454307698,\"userId\":2,\"content\":\"\\n      ## 2020-05-15 ~ 18（大更新）\\n\\n      ```\\n      # API:\\n      # FileUploadUtils 类增强\\n      # AddressUtils 新增获取当前应用访问根路径方法\\n      # 解决Mybatis配置类引起的 配置文件中相关配置失效的问题\\n      # 新增头像文件的本地静态资源映射路径的配置\\n      # 新增取消对 *.png、*.jpg图片的拦截\\n      # 新增对springboot启动之后的监听器MyCommandLineRunner，完成项目初始化工作\\n      # 新增分页工具类（对分页参数的封装）\\n      # 相关blog接口的重构\\n      # 新增blog中所需的默认头像\\n\\n      #前台\\n      #新增登录界面背景图\\n      #更新文章资源\\n      #相关bug修复\\n\\n      #后台\\n      #更新登录界面背景图\\n      #修复登录后无法获取头像的问题\\n      #新增文章审核、文章列表、分类管理、标签管理页面\\n      #相关bug修复\\n\\n      ```\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 06:22:30');
INSERT INTO `sys_oper_log` VALUES (50, '【请填写功能名称】', 2, 'com.jblog.project.blog.record.controller.RecordController.edit()', 'POST', 1, 'shadow', NULL, '/record/updateRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591454308000,\"id\":5,\"userId\":2,\"content\":\"      #前台\\n      #新增登录界面背景图\\n      #更新文章资源\\n      #相关bug修复\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 06:22:53');
INSERT INTO `sys_oper_log` VALUES (51, '【请填写功能名称】', 2, 'com.jblog.project.blog.record.controller.RecordController.edit()', 'POST', 1, 'shadow', NULL, '/record/updateRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591454308000,\"id\":5,\"userId\":2,\"content\":\"    #后台\\n      #更新登录界面背景图\\n      #修复登录后无法获取头像的问题\\n      #新增文章审核、文章列表、分类管理、标签管理页面\\n      #相关bug修复\\n\\n\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 06:23:07');
INSERT INTO `sys_oper_log` VALUES (52, '【请填写功能名称】', 2, 'com.jblog.project.blog.record.controller.RecordController.edit()', 'POST', 1, 'shadow', NULL, '/record/updateRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591454308000,\"id\":5,\"userId\":2,\"content\":\"    #后台\\n      #更新登录界面背景图\\n      #修复登录后无法获取头像的问题\\n      #新增文章审核、文章列表、分类管理、标签管理页面\\n      #相关bug修复\\n\\n\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 06:23:12');
INSERT INTO `sys_oper_log` VALUES (53, '【请填写功能名称】', 2, 'com.jblog.project.blog.record.controller.RecordController.edit()', 'POST', 1, 'shadow', NULL, '/record/updateRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591454308000,\"id\":5,\"userId\":2,\"content\":\"      #前台\\n      #新增登录界面背景图\\n      #更新文章资源\\n      #相关bug修复\\n\\n\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 06:23:32');
INSERT INTO `sys_oper_log` VALUES (54, '【请填写功能名称】', 1, 'com.jblog.project.blog.record.controller.RecordController.add()', 'POST', 1, 'shadow', NULL, '/record/addRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591454551980,\"userId\":2,\"content\":\"aaa\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 06:26:36');
INSERT INTO `sys_oper_log` VALUES (55, '【请填写功能名称】', 1, 'com.jblog.project.blog.record.controller.RecordController.add()', 'POST', 1, 'shadow', NULL, '/record/addRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591454554066,\"userId\":2,\"content\":\"aaa\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 06:26:37');
INSERT INTO `sys_oper_log` VALUES (56, '【请填写功能名称】', 1, 'com.jblog.project.blog.record.controller.RecordController.add()', 'POST', 1, 'shadow', NULL, '/record/addRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591454558619,\"userId\":2,\"content\":\"aaa\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 06:26:43');
INSERT INTO `sys_oper_log` VALUES (57, '【请填写功能名称】', 3, 'com.jblog.project.blog.record.controller.RecordController.remove()', 'POST', 1, 'shadow', NULL, '/record/deleteRecord', '127.0.0.1', '内网IP', '8', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 06:26:47');
INSERT INTO `sys_oper_log` VALUES (58, '【请填写功能名称】', 3, 'com.jblog.project.blog.record.controller.RecordController.remove()', 'POST', 1, 'shadow', NULL, '/record/deleteRecord', '127.0.0.1', '内网IP', '7', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 06:26:48');
INSERT INTO `sys_oper_log` VALUES (59, '【请填写功能名称】', 2, 'com.jblog.project.blog.record.controller.RecordController.edit()', 'POST', 1, 'shadow', NULL, '/record/updateRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591454552000,\"id\":6,\"userId\":2,\"content\":\"aaabbb\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 06:26:52');
INSERT INTO `sys_oper_log` VALUES (60, '【请填写功能名称】', 3, 'com.jblog.project.blog.record.controller.RecordController.remove()', 'POST', 1, 'shadow', NULL, '/record/deleteRecord', '127.0.0.1', '内网IP', '6', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 06:26:56');
INSERT INTO `sys_oper_log` VALUES (61, '【请填写功能名称】', 2, 'com.jblog.project.blog.record.controller.RecordController.edit()', 'POST', 1, 'shadow', NULL, '/record/updateRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591454552000,\"id\":6,\"userId\":2,\"content\":\"      #后台\\n      #更新登录界面背景图\\n      #修复登录后无法获取头像的问题\\n      #新增文章审核、文章列表、分类管理、标签管理页面\\n      #相关bug修复\\n\"}', '{\"msg\":\"操作失败\",\"code\":500}', 0, NULL, '2020-06-06 06:27:03');
INSERT INTO `sys_oper_log` VALUES (62, '【请填写功能名称】', 2, 'com.jblog.project.blog.record.controller.RecordController.edit()', 'POST', 1, 'shadow', NULL, '/record/updateRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591454552000,\"id\":6,\"userId\":2,\"content\":\"      #后台\\n      #更新登录界面背景图\\n      #修复登录后无法获取头像的问题\\n      #新增文章审核、文章列表、分类管理、标签管理页面\\n      #相关bug修复\\n\"}', '{\"msg\":\"操作失败\",\"code\":500}', 0, NULL, '2020-06-06 06:27:05');
INSERT INTO `sys_oper_log` VALUES (63, '【请填写功能名称】', 2, 'com.jblog.project.blog.record.controller.RecordController.edit()', 'POST', 1, 'shadow', NULL, '/record/updateRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591454552000,\"id\":6,\"userId\":2,\"content\":\"      #后台\\n      #更新登录界面背景图\\n      #修复登录后无法获取头像的问题\\n      #新增文章审核、文章列表、分类管理、标签管理页面\\n      #相关bug修复\\n\"}', '{\"msg\":\"操作失败\",\"code\":500}', 0, NULL, '2020-06-06 06:27:18');
INSERT INTO `sys_oper_log` VALUES (64, '【请填写功能名称】', 2, 'com.jblog.project.blog.record.controller.RecordController.edit()', 'POST', 1, 'shadow', NULL, '/record/updateRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591454308000,\"id\":5,\"userId\":2,\"content\":\"      #前台\\n      #新增登录界面背景图\\n      #更新文章资源\\n      #相关bug修复\\n\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 06:27:46');
INSERT INTO `sys_oper_log` VALUES (65, '【请填写功能名称】', 2, 'com.jblog.project.blog.record.controller.RecordController.edit()', 'POST', 1, 'shadow', NULL, '/record/updateRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591454308000,\"id\":5,\"userId\":2,\"content\":\"sss\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 06:27:54');
INSERT INTO `sys_oper_log` VALUES (66, '【请填写功能名称】', 2, 'com.jblog.project.blog.record.controller.RecordController.edit()', 'POST', 1, 'shadow', NULL, '/record/updateRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591454308000,\"id\":5,\"userId\":2,\"content\":\"bbb\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 06:27:59');
INSERT INTO `sys_oper_log` VALUES (67, '【请填写功能名称】', 3, 'com.jblog.project.blog.record.controller.RecordController.remove()', 'POST', 1, 'shadow', NULL, '/record/deleteRecord', '127.0.0.1', '内网IP', '5', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 06:28:22');
INSERT INTO `sys_oper_log` VALUES (68, '【请填写功能名称】', 1, 'com.jblog.project.blog.record.controller.RecordController.add()', 'POST', 1, 'shadow', NULL, '/record/addRecord', '127.0.0.1', '内网IP', '{\"createdAt\":1591454667651,\"userId\":2,\"content\":\"      #后台\\n      #更新登录界面背景图\\n      #修复登录后无法获取头像的问题\\n      #新增文章审核、文章列表、分类管理、标签管理页面\\n      #相关bug修复\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2020-06-06 06:28:30');
...
INSERT INTO `sys_user` VALUES (2, 105, 'shadow', 'shadow', '00', '2581992919@qq.com', '1566622222', '0', 'dd2a996e71f82ef495b2a942171e0a92.png', '$2a$10$3yyWb2WJ30WabiVkBcC8XOhEKhw4g8YqNhNCcYRBVCYWHpYSfpVDi', '0', '0', '127.0.0.1', '2018-03-16 11:33:00', 'admin', '2020-05-10 11:33:00', 'shadow', '2020-06-05 20:26:51', '管理员', '湖南长沙', '勇往直前111');
INSERT INTO `sys_user` VALUES (108, NULL, '小方块', '小方块', '00', '3465370452@qq.com', '17300000000', '0', 'avatar.png', '$2a$10$Wq9wK7Xaq9x39B3QYp1J6e87wlj0YI/9ZOiveQqM6Mc7UDlmmhVMK', '0', '0', '', NULL, '小方块', '2020-05-30 11:48:27', 'happy', '2020-06-06 05:04:54', NULL, '湖南长沙', '极速前进');
